...
# creating file path to connect to the dbfile, you will need to download sqlite pip in order to use this file and use your own file path where the DB bis located
...
#---Constants---#
maintList = ("Battery #5679", "Battery #3565", "Battery #4890", "Battery #6780")
